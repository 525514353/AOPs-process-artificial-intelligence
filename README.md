...
If you find this project or code useful for your research, please consider citing our work using the following BibTeX entry:

```bibtex
@article{huang2023interpretable,
  title={Interpretable artificial intelligence for advanced oxidation systems: Principle, operations and performance},
  author={Huang, Zhi and Yu, Jiang and Shao, Xiao and Jiang, Yinying and Yu, Jie and Deng, Siwei and Li, Peirou},
